                    ...
                    <table class="table list-table-wp">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span
                                        class="tbody-text"><?php if (!empty($slider['created_at'])) echo date('d/m/Y', $slider['created_at']); ?></span>
                                </td>
                                <td>
                                    <ul class="list-operation">
                                        <li><a href="?mod=slider&action=update&slider_id=<?php echo $slider['slider_id']; ?>"
                                                title="Sửa" class="edit text-success"><i class="fa fa-pencil"
                                                    aria-hidden="true"></i></a></li>
                                        <li><a href="?mod=slider&action=delete&slider_id=<?php echo $slider['slider_id']; ?>"
                                                title="Xóa" class="delete text-danger"><i class="fa fa-trash"
                                                    aria-hidden="true"></i></a></li>
                                    </ul>
                                </td>
                            </tr>
