    ...
    <ul id="sidebar-menu">
        ...
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=product&controller=indexCategory&action=index" title="" class="nav-link">Danh mục sản
                        phẩm</a>
                </li>
            </ul>
        </li>
        <li class="nav-item">
            ...
            <ul class="sub-menu">
                ...
                <li class="nav-item">
                    <a href="?mod=post&controller=category&action=index" title="" class="nav-link">Danh mục bài viết</a>
                </li>
            </ul>
        </li>
        <!-- <li class="nav-item">
